...
public class Pregunta10 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i=new Intent(Pregunta10.this,Terminar_Evaluacion.class);
        verdadero = (Button) findViewById(R.id.btn1_verdadero10);
        falso = (Button) findViewById(R.id.btn_false10);
        sig = (Button) findViewById(R.id.btn_sig10);
        try {
            recibe = getIntent();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn1_verdadero10:
                calificacion += 1;
                deshabilitar();
                break;

            case R.id.btn_false10:
                calificacion += 0;
                deshabilitar();
                break;
